...
const UserDescription = ({ basicDetails }: UserDescriptionProps) => {
  ...
  const authenticatedUser = authenticatedUserString ? JSON.parse(authenticatedUserString) : null;
  const authenticatedUserEmail = authenticatedUser ? authenticatedUser.email : "";
